...
public class valmart extends vendor{
   ...
   public JFrame frame;
	...
	private void initialize() {
		...
		lblpostitTabsWith.setBounds(6, 6, 130, 64);
		...
		lblexpoLowOdor.setBounds(6, 6, 130, 64);
		...
		lblSoftyellow.setBounds(6, 6, 130, 65);
		...
		lblsmeadManilaFile.setBounds(6, 6, 130, 76);
